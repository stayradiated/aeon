      ...
      rows: [
        {
          ...
          endDate: fromUTC(2024, 0, 7),
          cells: [
            { date: fromUTC(2024, 0, 1), tracks: [] },
            { date: fromUTC(2024, 0, 2), tracks: [] },
            { date: fromUTC(2024, 0, 3), tracks: [] },
            { date: fromUTC(2024, 0, 4), tracks: [] },
            { date: fromUTC(2024, 0, 5), tracks: [] },
            { date: fromUTC(2024, 0, 6), tracks: [] },
            { date: fromUTC(2024, 0, 7), tracks: [] },
          ],
        },
      ],
    })
    ...
    expect(grid).toStrictEqual({
      ...
      rows: [
        ...
        },
        {
          ...
          endDate: fromUTC(2024, 0, 14),
          cells: [
            { date: fromUTC(2024, 0, 8), tracks: [] },
            { date: fromUTC(2024, 0, 9), tracks: [] },
            { date: fromUTC(2024, 0, 10), tracks: [] },
            { date: fromUTC(2024, 0, 11), tracks: [] },
            { date: fromUTC(2024, 0, 12), tracks: [] },
            { date: fromUTC(2024, 0, 13), tracks: [] },
            { date: fromUTC(2024, 0, 14), tracks: [] },
          ],
        },
      ],
    })
      ...
      rows: [
        {
          ...
          cells: [
            undefined,
            undefined,
            { date: fromUTC(2025, 0, 1), tracks: [] },
            { date: fromUTC(2025, 0, 2), tracks: [] },
            { date: fromUTC(2025, 0, 3), tracks: [] },
            { date: fromUTC(2025, 0, 4), tracks: [] },
            { date: fromUTC(2025, 0, 5), tracks: [] },
          ],
        },
        {
          trackCount: 0,
          ...
          cells: [
            { date: fromUTC(2025, 0, 6), tracks: [] },
            { date: fromUTC(2025, 0, 7), tracks: [] },
            { date: fromUTC(2025, 0, 8), tracks: [] },
            { date: fromUTC(2025, 0, 9), tracks: [] },
            { date: fromUTC(2025, 0, 10), tracks: [] },
            { date: fromUTC(2025, 0, 11), tracks: [] },
            { date: fromUTC(2025, 0, 12), tracks: [] },
          ],
        },
        {
          trackCount: 0,
          ...
          endDate: fromUTC(2025, 0, 14),
          cells: [
            { date: fromUTC(2025, 0, 13), tracks: [] },
            { date: fromUTC(2025, 0, 14), tracks: [] },
            undefined,
            undefined,
            undefined,
            undefined,
      ...
      rows: [
        {
          ...
          endDate: fromUTC(2024, 0, 7),
          cells: [
            { date: fromUTC(2024, 0, 1), tracks: [trackA] },
            { date: fromUTC(2024, 0, 2), tracks: [trackA] },
            { date: fromUTC(2024, 0, 3), tracks: [trackA] },
            { date: fromUTC(2024, 0, 4), tracks: [trackA] },
            { date: fromUTC(2024, 0, 5), tracks: [trackA] },
            { date: fromUTC(2024, 0, 6), tracks: [trackA] },
            { date: fromUTC(2024, 0, 7), tracks: [trackA] },
          ],
        },
      ],
    })
      ...
      rows: [
        {
          ...
          endDate: fromUTC(2024, 0, 7),
          cells: [
            { date: fromUTC(2024, 0, 1), tracks: [trackA, undefined] },
            { date: fromUTC(2024, 0, 2), tracks: [trackA, trackB] },
            { date: fromUTC(2024, 0, 3), tracks: [trackC, trackB] },
            { date: fromUTC(2024, 0, 4), tracks: [trackC, trackD] },
            { date: fromUTC(2024, 0, 5), tracks: [trackE, trackD] },
            { date: fromUTC(2024, 0, 6), tracks: [trackE, trackF] },
            { date: fromUTC(2024, 0, 7), tracks: [undefined, trackF] },
          ],
        },
      ],
    })
